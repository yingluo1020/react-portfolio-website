            ...
            <div className="container portfolio_container ">
                ...
                <article className='portfolio'>
                    ...
                    <div className="portfolio_link">
                        ...
                        <a href="http://githubsearch.yingluoresume.com" target='_blank' className='btn btn-primary'>Live Demo</a>
                    </div>
                </article>
                ...
                <article className='portfolio'>
                    ...
                    <div className="portfolio_link">
                        ...
                        <a href="http://calculator.yingluoresume.com" target='_blank' className='btn btn-primary'>Live Demo</a>
                    </div>
                </article>
