                ...
                <div className="about_content">
                    <div className="about_cards">
                        <article className="about_card">
                            ...
                            <h5>Guangdong Polytechnic University</h5>
                            <small>BA in English</small><br />
                            <small>Garde obtained 1st (83%)</small>
                        </article>

                        <article className="about_card">
                            <FaAward className='about_icon' />
                            <h5>The University of Sheffield</h5><br />
                            <small>MA in Education</small><br />
                            <small>Garde obtained 1st (68%)</small>
                        </article>
                        <article className="about_card">
                            ...
                            <small>JavaScript, React, Python </small>
